...
class AllTransactionApapter(
...
) : RecyclerView.Adapter<AllTransactionApapter.AllTransactionAdapterViewHolder>() {

    private val db = FirebaseFirestore.getInstance()

    class AllTransactionAdapterViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AllTransactionAdapterViewHolder {
        val itemView = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_transaction, parent, false)
        return AllTransactionAdapterViewHolder(itemView)
    }

    override fun onBindViewHolder(holder: AllTransactionAdapterViewHolder, position: Int) {
